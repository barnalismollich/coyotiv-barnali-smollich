...
.about
    ...
    p
      ...
      a(href='https://www.privacypolicies.com/cookies-policy-generator/', target='_blank') Cookies Policy Generator
      | .
    p
    ...
    ul
      li
        strong Company
        |  (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to FamilyDiary.
      li
        strong Cookies
      ...
      li
        strong Website
        |  refers to FamilyDiary, accessible from
        a(href='https://frontend-5aoh42seuq-ew.a.run.app/', rel='external nofollow noopener', target='_blank') https://frontend-5aoh42seuq-ew.a.run.app/
      li
        strong You
    ...
    ul
      li
        p
          ...
          a(href='https://support.google.com/accounts/answer/32050', rel='external nofollow noopener', target='_blank') https://support.google.com/accounts/answer/32050
      li
        p
          | For the Internet Explorer web browser, please visit this page from Microsoft:
          a(href='http://support.microsoft.com/kb/278835', rel='external nofollow noopener', target='_blank') http://support.microsoft.com/kb/278835
      li
        p
          | For the Firefox web browser, please visit this page from Mozilla:
          a(href='https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored', rel='external nofollow noopener', target='_blank') https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored
      li
        p
    ...
    p
      ...
      a(href='https://www.privacypolicies.com/blog/cookies/', target='_blank') What Are Cookies?
      | .
    h2 Contact Us
